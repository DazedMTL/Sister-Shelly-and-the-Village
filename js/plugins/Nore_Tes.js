...
(function (Nore) {
  ...
  (function (Tes) {
    ...
    var Scenario_Converter = /** @class */ (function () {
       ...
       * ○ メニュー画面を開く
       */
      Scenario_Converter.prototype.convertCommnad_menu_open = function (
        context
      ) {
       ...
       * ○ セーブ画面を開く
       */
      Scenario_Converter.prototype.convertCommnad_save_open = function (
        context
      ) {
       ...
       * ○ ゲームオーバー
       */
      Scenario_Converter.prototype.convertCommnad_gameover = function (
        context
      ) {
       ...
       * ○ タイトル画面に戻す
       */
      Scenario_Converter.prototype.convertCommnad_title_return = function (
        context
      ) {
    ...
    if (COSTOM_FADE_IN_OUT === true) {
      ...
      Game_Interpreter.prototype.command221 = function (params) {
        ...
        if ($gameVariables.value(25)) {
          fadeSpeed = $gameVariables.value(25);
        }
