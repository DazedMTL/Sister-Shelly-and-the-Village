...
(function (Nore) {
  ...
  var Window_Pan = /** @class */ (function (_super) {
    ...
    Window_Pan.prototype.drawCurrencyValue = function (
      ...
      this.drawNumber(value, x, y, width - 6, "right", 11);
      var value2 = $gameParty.numItems($dataItems[WINE_ID]);
      //this.drawText(value2, x, y + this.lineHeight(), width  - 6, "right");
      this.drawNumber(value2, x, y + this.lineHeight(), width - 6, "right", 11);
    ...
    Window_Pan.prototype.setItem = function (item) {
      ...
      text = text.replace("\\n", "\n");
      this.drawTextEx(text, 230, 30, 400);
    };
  ...
  var Window_PanYakusou = /** @class */ (function (_super) {
    __extends(Window_PanYakusou, _super);
    function Window_PanYakusou() {
      return (_super !== null && _super.apply(this, arguments)) || this;
    }
    Window_PanYakusou.prototype.initialize = function (r) {
      _super.prototype.initialize.call(this, r);
      this.refreshBg();
      this.frameVisible = false;
      this.backOpacity = 0;
    };
    Window_PanYakusou.prototype.refreshBg = function () {
      var baseTexture = Nore.getSystemBaseTexture("menu2");
      var rect = new PIXI.Rectangle(0, 430, 500, 200);
      if (ConfigManager.en) {
        rect = new PIXI.Rectangle(523, 430, 500, 200);
      }
    ...
    Window_PanYakusou.prototype.value = function () {
      return $gameParty.numItems($dataItems[PAN_ID]);
    };
    Window_PanYakusou.prototype.drawCurrencyValue = function (
      value,
      unit,
      x,
      y,
      ...
      this._windowContentsSprite.removeChildren();
      this.drawNumber(value, 78, 102, 100, "right", 13);
      var value2 = $gameParty.numItems($dataItems[WINE_ID]);
      this.drawNumber(value2, 198, 102, 100, "right", 13);
      var value3 = $gameParty.numItems($dataItems[YAKUSOU_ID]);
      this.drawNumber(value3, 318, 102, 100, "right", 13);
    };
    return Window_PanYakusou;
  })(Window_Gold);
  Nore.Window_PanYakusou = Window_PanYakusou;
